...
estructura_red=[entradas,10,10,10,salidas];
...
tiempo_entrenamiento=toc
 %% validation
 plotting=1;
[Y_salida,err_val_all,err_val_por]=NN_prediccion_bias(layer,Xv,Yv,estructura_red,plotting);